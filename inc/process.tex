...
\end{itemize}
\newglossaryentry{agile}{name=agile, description={\Gls{developmentMethodology} focused on adaptability and requirements or solutions evolve through the collaborative effort of self-organizing and cross-functional teams and their end user. \cite{beck2001manifesto}}}
...
The team had to plan for high degree of uncertainty, making \gls{agile} a requirement. With the teams experience level, it seemed like \gls{scrum} would be a good fit. \Gls{scrum} fit well with the focus on code and code-quality, but would still generate enough documentation to help with professionalism. 
The team used ideas from \gls{devops} along with \gls{scrum}, to improve documentation and embed the documentation together with code.  
...
\newglossaryentry{vetter}{name=vetter, description={A computer program used for formatting.}}
...
\newglossaryentry{apidoc}{name={APIDOC}, description={RESTful web API Documentation Generator.}}
...
\newglossaryentry{fullstack}{name={full-stack}, description={Something that touches all levels between \gls{client} and \gls{backend}}}
...
As shown in figure \ref{fig:scrumBoar}, the workflow was divided into 4 parts:
...
\newglossaryentry{frontend}{name={front-end}, description={front-end is presentation layer of a software}}
...
In this sprint the idea was to make a prototype that could represent a function definition from a \gls{git} repository \gls{uri}. The prototype should also indicate the user if the browser does not support \gls{webgl}.
...
Some of the tasks in this \gls{sprint} were still big task and dependent on other tasks. Tasks such as display function calls was a very difficult \gls{fullstack} task that existed throughout all \glspl{sprint}. 
...
\subsection{Sprint: complex parsing and scope visual (12.mar - 18.mar)}
\begin{figure}[H] 
...
This \gls{sprint} had a primary focus on testing and since no testing had been done and there were a lot of tests to write, team decided to make this a two weeks long \gls{sprint}. 
