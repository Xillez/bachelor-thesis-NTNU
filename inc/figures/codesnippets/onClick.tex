\newglossaryentry{raycasting}{name={raycasting}, description={The use of ray–surface intersection tests to solve a variety of problems in computer graphics and computational geometry. \cite{wiki:raycasting}}}
